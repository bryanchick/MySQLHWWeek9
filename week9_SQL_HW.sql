...
SELECT payment.staff_id, staff.first_name, staff.last_name, payment.amount,
...
AS 'Number of Copies'
FROM film
WHERE title = "Hunchback Impossible"; -- answer is 6
...
GROUP BY 1
ORDER BY 'Times Rented' DESC; -- 'ACADEMY DINOSAUR', '23'
...
ORDER BY Gross
LIMIT 5;
-- 'Music', '3417.72' 'Travel', '3549.64' 'Classics', '3639.59'
-- 'Children', '3655.55' 'Horror', '3722.54'
